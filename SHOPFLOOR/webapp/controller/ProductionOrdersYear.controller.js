sap.ui.define([
    ...
    return Controller.extend("SHOPFLOOR.controller.ProductionOrdersYear", {
        onInit: function () {
        ...
        _resetToOriginalData: function () {
            var oViewModel = this.getView().getModel("viewModel");
            var oOriginalData = this._oModel.getData();
            if (oOriginalData && oOriginalData.results) {
                oViewModel.setProperty("/data", oOriginalData.results);
            }
        }
    });
});
